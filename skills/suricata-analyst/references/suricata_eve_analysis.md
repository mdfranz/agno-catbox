...
Create, edit, and save code in the current directory

- DO NOT USE THE CONVENTION `python3 << 'EOF'` or `python3 -c` 
- SAVE AND RETATAIN ALL SCRIPTS


## 1. Environment Setup

Start every investigation by creating the environment first if it doesn't exist already!
...
Do NOT use `UV_CACHE_DIR` option. Assume there is a `.venv`
